...
function M.setup(opts)
	...
	set("FloatTitle", { fg = p.blue, bg = p.bg_alt })
	...
	set("IncSearch", { fg = p.bg, bg = p.honey_dim, bold = true })
	...
	set("Pmenu", { fg = p.muted, bg = p.bg_alt })
	...
	set("StorageClass", { fg = p.honey_dim })
	set("Structure", { fg = p.honey_dim })
	set("Typedef", { fg = p.honey_dim })
	...
	set("gitHashAbbrev", { fg = p.honey_dim })
